  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 px-6 relative overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-100 min-h-[70vh]">
      ...
      <div className="w-full max-w-sm bg-white/80 backdrop-blur border border-zinc-200 p-10 rounded-2xl shadow-xl z-10">
        <h1 className="text-3xl font-serif text-center mb-8 text-zinc-900 border-b border-zinc-100 pb-6 tracking-wide">Acceso Seguro</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">Usuario Autorizado</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">Clave de Bóveda</label>
            <input 
              type="password" 
          ...
          >
            {loading ? 'Desencriptando...' : 'Desbloquear Panel'}
          </button>
        </form>
      </div>
    </div>
