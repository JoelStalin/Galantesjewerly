        ...
        <ConditionalFooter>
          ...
          {finalSettings.facebook_url && (
            <a
              ...
              aria-label="Facebook"
              className="fixed bottom-[9.5rem] right-6 z-50 hidden md:flex items-center justify-center rounded-full bg-[#1877F2] p-4 text-white shadow-lg transition-transform hover:scale-110"
          ...
          {finalSettings.instagram_url && (
            <a
              ...
              className="fixed bottom-[5.5rem] right-6 z-50 hidden md:flex items-center justify-center rounded-full p-4 text-white shadow-lg transition-transform hover:scale-110"
          ...
          {finalSettings.whatsapp_number && (
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex items-center justify-center rounded-full bg-[#25D366] p-3 md:p-4 text-white shadow-lg transition-transform hover:scale-110"
